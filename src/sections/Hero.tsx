...
function Hero() {
  ...
  <Element name='home' className="w-full  flex flex-col items-center  ">
    ...
    <div className='w-[98%] flex justify-center overflow-hidden lg:w-[98%] lg:rounded-4xl '
      style={{ backgroundImage: `url(${textureimg})`, backgroundSize: "contain",backgroundRepeat : 'repeat' }} >
   <div className='w-full pt-32 pb-8  flex flex-col items-center justify-center bg-gradient-to-b from-black via-blue-500/20 to-black  px-8 sm:px-12 lg:px-24 lg:via-black/30 lg:to-blue-500/40 lg:pb-32 xl:px-52 lg:pt-44'>
     ...
     <div className=" bg-gradient-to-t from-white/10 via-white/5 to-white/10 backdrop-blur-md rounded-2xl border border-white/10 shadow-lg
        flex justify-center items-center text-white gap-2 p-2 pr-5 font-semibold min-w-[200px] ">
          <p className="bg-ctmblue  px-3 rounded-xl shadow-md shadow-black/50 text-sm lg:text-xl">Now</p>
            ...
            <h1 className='text-sm text-center lg:text-xl '>Available for Work</h1>
        </div>

        <div className=' grid place-items-center mt-12 text-center lg:mt-16  '>
...
Crafting Sites That Look Good & Work Great.</h1>
          <p className='text-gray-300 mt-8 text-base lg:text-2xl lg:mt-12'>Looking for a reliable web developer for your next project? I’m here to help.</p>
